...
export async function GET(request: Request,
  ...
  try {
    ...
    const formattedMembers = members.map((member) => ({
      ...
      speciality: member.user.speciality,
      services: member.user.services,
    ...
    return NextResponse.json({ error: "Une erreur est survenue lors de la récupération des membres" }, { status: 500 })
  }
}
