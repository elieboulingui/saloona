...
export function NotificationSettings() {
  ...
  const subscribeToNotifications = async () => {
    ...
    try {
      ...
      const vapidPublicKey = "BNWiGTUJozjVWT3WJ1GzAbz74V9XGl_G3oFeiyxJcCO60L-F672BxqJ7IaPp4VAVE2LPpPKeptsfLzTRe2Zdnc8"
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Les notifications ne sont pas supportées par votre navigateur.</CardDescription>
        </CardHeader>
      </Card>
    )
  }
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Notifications</CardTitle>
        <CardDescription>
          Recevez des notifications pour les nouvelles réservations et les événements importants.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-500">
              {isSubscribed
                ? "Vous recevez des notifications pour les nouvelles réservations."
                : "Activez les notifications pour être informé des nouvelles réservations."}
            </p>
          </div>
          <Switch
            id="notifications"
        ...
        {permission === "denied" && (
          <div className="mt-4 p-3 bg-red-50 text-red-700 rounded-md text-sm">
            <p>
              Les notifications sont bloquées par votre navigateur. Veuillez modifier les paramètres de votre navigateur
              pour autoriser les notifications de ce site.
            </p>
          </div>
        )}
        ...
        <div className="mt-6">
          <Button
            ...
            className={isSubscribed ? "border-red-500 text-red-500" : "bg-amber-500 hover:bg-amber-600"}
